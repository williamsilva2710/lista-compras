...
async function carregarLista() {
  ...
  data.forEach((item) => {
    ...
    li.innerHTML = `${item.item} <button onclick="removerItem('${item.id}')" style="border: none; background-color: #fff; cursor:pointer; list-style: none; left: 0;"><i class="fa-solid fa-trash"></i></button>`
